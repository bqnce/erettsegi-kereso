  ...
  title, errorMsg, options, onValueChange, darkMode
    ...
    return (
      <Popover open={open} onOpenChange={setOpen}>
        ...
        <PopoverContent className={`w-[200px] p-0 border bg-transparent dark:border-[#1f1f1f] border-[#dcdcdc]"}`}>
          <Command className={`dark:bg-[#070707] dark:text-[#dbdbdb] bg-[#f9f9f9] text-[#070707]"}`}>
